...
public class Point implements Comparable<Point> {
     ...
     *
    http://coursera.cs.princeton.edu/algs4/testing/collinear/LineSegment.java * @param  x the <em>x</em>-coordinate of the point
    ...
    public double slopeTo(Point that) {
        ...
        double m = (double)(that.y - this.y) / (that.x - this.x);
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(pts);
        // Collections.sort(pts, Point.slopeOrder());
        // for (Point a : pts)
        //     System.out.println(a.toString());

        // double tmp = p1.slopeTo(p2);
